...
const Slider = () => {
    return (
      <div>
        <div className="carousel w-full rounded-lg mt-6">
          <div
            id="slide1"
          ...
          >
            ...
            >
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-amber-400 max-w-3xl ml-6 md:ml-24 mt-6 md:mt-40">
          ...
          >
            ...
            <div
              ...
              className="absolute  w-full h-[400px] md:h-[600px]"
            >
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold  text-amber-400 max-w-3xl ml-6 md:ml-24 mt-6 md:mt-36">
